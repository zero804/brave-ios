...
class BraveShieldStatsView: UIView, Themeable {
    ...
    var dataSaved: String {
        ...
        let formatter = ByteCountFormatter().then {
            ...
            // This is for extra safety only, there's virtually zero sub 1000 bytes tracker scripts in the wild.
